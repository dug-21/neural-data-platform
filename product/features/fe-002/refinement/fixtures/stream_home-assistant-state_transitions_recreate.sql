...
-- Drop existing views
DROP VIEW IF EXISTS gold.home_assistant_state_transitions_actual CASCADE;
DROP MATERIALIZED VIEW IF EXISTS gold.home_assistant_state_transitions CASCADE;
