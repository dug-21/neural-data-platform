...
mod integration_tests {
    ...
    async fn test_redis_connection_and_operations() {
        ...
        match adapter.connect().await {
            Ok(_) => {
                ...
                let result = adapter
                    .set_latest_price("BTC/USDT", 50000.0, Utc::now().timestamp())
                    .await;
            ...
            Err(e) => {
                ...
                println!(
                    "⚠️  Redis not available for testing: {}. Skipping Redis tests.",
                    e
                );
            }
        }
    ...
    async fn test_daa_coordinator_decisions() {
        ...
        let decision_with_position = coordinator
    ...
    async fn test_complete_integration_flow() {
        ...
        if redis_connected {
            ...
            let publish_result = redis_adapter
                .publish_market_data("market:updates", &market_data)
                .await;
            assert!(publish_result.is_ok());

            // Subscribe to Redis channel
            let mut stream = redis_adapter
                .subscribe_market_data("market:updates")
                .await
                .unwrap();
    ...
    async fn test_error_handling_and_recovery() {
        ...
        let decision_result = coordinator
            .make_decision(&invalid_market, None, &empty_data)
            .await;
    ...
    async fn test_performance_and_concurrency() {
        ...
        for (i, symbol) in symbols.iter().enumerate() {
            ...
            let handle = tokio::spawn(async move {
                ...
                let historical_data =
                    create_time_series_data(&symbol, market_context.current_price, 20);
        ...
        assert_eq!(
            decision_count, 25,
            "Should receive 5 decisions per symbol × 5 symbols"
        );
    ...
    async fn test_memory_and_state_management() {
        ...
        let store_result = event_bus
            .store_in_memory(test_key, test_value.clone())
            .await;
    ...
    async fn test_edge_cases() {
        ...
        for market in extreme_cases {
            ...
            let decision = coordinator
                .make_decision(&market, None, &minimal_data)
                .await;
    ...
    async fn test_position_management_integration() {
        ...
        for position in positions {
            ...
            let historical_data =
                create_time_series_data(&position.symbol, position.current_price, 50);
    ...
    async fn test_high_frequency_decisions() {
        ...
        for i in 0..iterations {
            ...
            let handle = tokio::spawn(async move {
                ...
                coordinator_clone
                    .make_decision(&market_context, None, &data)
                    .await
            });
