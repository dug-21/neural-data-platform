...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if !main_proto_files.is_empty() {
        ...
        tonic_build::configure()
            ...
            .type_attribute(
                "neural_trader.market_data.v1.DataType",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            .type_attribute(
                "neural_trader.common.v1.CommonErrorCode",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            .type_attribute(
                "neural_trader.models.v1.ModelType",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            .type_attribute(
                "neural_trader.models.v1.TrainingStage",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            .type_attribute(
                "neural_trader.models.v1.DeploymentStatus",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            .type_attribute(
                "neural_trader.trading.v1.OrderSide",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            .type_attribute(
                "neural_trader.trading.v1.OrderType",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            .type_attribute(
                "neural_trader.trading.v1.OrderState",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            // Add config-store specific enums
            .type_attribute(
                "neural_platform.config.ValueType",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            .type_attribute(
                "neural_platform.config.ChangeType",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            // Use fully qualified names for enum imports to avoid conflicts
            .extern_path(".google.protobuf", "::prost_types")
            .extern_path(
                ".neural_trader.common.v1",
                "crate::proto::neural_trader::common::v1",
            )
    ...
    if !schema_proto_files.is_empty() {
        ...
        tonic_build::configure()
            ...
            .type_attribute(
                "neural_trader.interfaces.ingestion.ValidationStatus",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            .type_attribute(
                "neural_trader.interfaces.mlops.SourceType",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            .type_attribute(
                "neural_trader.interfaces.mlops.Severity",
                "#[derive(serde::Serialize, serde::Deserialize)]",
            )
            // Rename the conflicting DataType enum by adding namespace prefix
            .type_attribute(
                "neural_trader.interfaces.mlops.FeatureDefinition.DataType",
                "#[allow(clippy::enum_variant_names)]",
            )
            .type_attribute(
                "neural_trader.interfaces.execution.DataType",
                "#[allow(clippy::enum_variant_names)]",
            )
    ...
    if main_proto_files.is_empty() && schema_proto_files.is_empty() {
        println!(
            "cargo:warning=No .proto files found in {:?} or {:?}",
            proto_dir, schemas_dir
        );
    }
