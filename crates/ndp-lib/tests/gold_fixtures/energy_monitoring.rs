...
use ndp_lib::gold::config::types::{
    AggregatesConfig, FeaturesConfig, FieldConfig, FieldMetricsConfig, GoldEtlConfig,
    SilverEtlConfig, TransitionsConfig,
};
use ndp_lib::gold::{
    AlignmentConfig, DomainConfig, JoinStrategy, NullHandling, ObjectiveConfig, Priority,
    StreamConfig, StreamRef, StreamRole, TargetConfig,
};
...
pub fn create_energy_monitoring_domain() -> DomainConfig {
    DomainConfig {
        ...
        events: Some(ndp_lib::gold::EventsConfig {
            enabled: true,
