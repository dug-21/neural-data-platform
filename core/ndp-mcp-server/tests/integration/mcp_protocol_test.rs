...
async fn test_mcp_tools_list_returns_tools() {
    ...
    // Verify expected Bronze tools are present
    ...
    // Verify dp-010 Silver tools are present
    ...
    // Verify dp-010 Dictionary tools are present
    ...
    // Verify dp-010 ETL tools are present
