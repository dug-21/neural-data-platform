...
use config_store::{ConfigStore, ConfigValue, InMemoryConfigStore};
...
async fn test_market_hours_storage() {
    ...
    nyse.insert(
        "timezone".to_string(),
        ConfigValue::String("America/New_York".to_string()),
    );
    ...
    regular_hours.insert(
        "close".to_string(),
        ConfigValue::String("16:00".to_string()),
    );
    nyse.insert(
        "regular_hours".to_string(),
        ConfigValue::Object(regular_hours),
    );

    // Extended hours
    let mut extended_hours = HashMap::new();
    extended_hours.insert(
        "pre_market_open".to_string(),
        ConfigValue::String("04:00".to_string()),
    );
    extended_hours.insert(
        "pre_market_close".to_string(),
        ConfigValue::String("09:30".to_string()),
    );
    extended_hours.insert(
        "after_hours_open".to_string(),
        ConfigValue::String("16:00".to_string()),
    );
    extended_hours.insert(
        "after_hours_close".to_string(),
        ConfigValue::String("20:00".to_string()),
    );
    nyse.insert(
        "extended_hours".to_string(),
        ConfigValue::Object(extended_hours),
    );
    ...
    let fixed_holidays = vec![
        ConfigValue::Object({
            ...
            holiday.insert(
                "date".to_string(),
                ConfigValue::String("2024-01-01".to_string()),
            );
            holiday.insert(
                "name".to_string(),
                ConfigValue::String("New Year's Day".to_string()),
            );
            holiday
        }),
        ConfigValue::Object({
            ...
            holiday.insert(
                "date".to_string(),
                ConfigValue::String("2024-07-04".to_string()),
            );
            holiday.insert(
                "name".to_string(),
                ConfigValue::String("Independence Day".to_string()),
            );
            holiday
        }),
        ConfigValue::Object({
            ...
            holiday.insert(
                "date".to_string(),
                ConfigValue::String("2024-12-25".to_string()),
            );
            holiday.insert(
                "name".to_string(),
                ConfigValue::String("Christmas".to_string()),
            );
            holiday
        }),
    ];
    ...
    holidays.insert(
        "moveable".to_string(),
        ConfigValue::Array(moveable_holidays),
    );
    ...
    let open_time = store
        .get("/market_hours/NYSE/regular_hours/open")
        .await
        .unwrap();
...
async fn test_json_serialization() {
    ...
    exchange.insert(
        "timezone".to_string(),
        ConfigValue::String("UTC-5".to_string()),
    );
    exchange.insert(
        "open_time".to_string(),
        ConfigValue::String("09:30".to_string()),
    ...
    exchange.insert(
        "trading_days_per_year".to_string(),
        ConfigValue::Integer(252),
    );
    exchange.insert(
        "average_volume".to_string(),
        ConfigValue::Float(1_000_000_000.0),
    );
